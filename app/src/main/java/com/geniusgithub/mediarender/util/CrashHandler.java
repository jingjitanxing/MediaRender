...
/**
 * Created by lbs06 on 2017/11/9.
 */

public class CrashHandler implements Thread.UncaughtExceptionHandler {
  public static final String TAG = "JingjiCrashHandler";
  ...
  // 用于格式化日期,作为日志文件名的一部分
  private DateFormat formatter = new SimpleDateFormat("yyyy_MM_dd_HH_mm");
  ...
  private String saveCrashInfo2File(Throwable ex) {
    ...
    try {
      ...
      String path = getSdPath() + "CrashLog" + File.separator;
  ...
  private   String getSdPath() {
    return Environment.getExternalStorageDirectory() + "/MideaRender/";
  }
}
