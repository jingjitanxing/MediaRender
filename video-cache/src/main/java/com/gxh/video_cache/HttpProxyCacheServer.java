...
import com.gxh.video_cache.file.Md5FileNameGenerator;
import com.gxh.video_cache.file.TotalCountLruDiskUsage;
import com.gxh.video_cache.file.TotalSizeLruDiskUsage;
import com.gxh.video_cache.headers.EmptyHeadersInjector;
import com.gxh.video_cache.headers.HeaderInjector;
import com.gxh.video_cache.sourcestorage.SourceInfoStorage;
import com.gxh.video_cache.sourcestorage.SourceInfoStorageFactory;
import java.io.File;
...
import static com.gxh.video_cache.Preconditions.checkAllNotNull;
import static com.gxh.video_cache.Preconditions.checkNotNull;
...
public class HttpProxyCacheServer {
    ...
    public void registerCacheListener(CacheListener cacheListener, String url) {
        ...
        synchronized (clientsLock) {
            try {
                ...
                Log.i(TAG,"Error registering cache listener", e);
            }
        }
    }
    ...
    private void touchFileSafely(File cacheFile) {
        try {
            ...
            Log.i(TAG,"Error touching file " + cacheFile, e);
        }
    }
    ...
    private void processSocket(Socket socket) {
        try {
            ...
            Log.i(TAG,"Closing socket… Socket is closed by client.");
        } catch (ProxyCacheException | IOException e) {
            onError(new ProxyCacheException("Error processing request", e));
        } finally {
            releaseSocket(socket);
            Log.i(TAG,"Opened connections: " + getClientsCount());
        }
    }
...
//            // There is no way to determine that client closed connection http://stackoverflow.com/a/10241044/999458
//            // So just to prevent log flooding don't log stacktrace
//            Log.i(TAG,"Releasing input stream… Socket is closed by client.");
//        } catch (IOException e) {
...
//        }
    ...
    private void closeSocketOutput(Socket socket) {
        try {
            ...
            Log.i(TAG,"Failed to close socket on proxy side: {}. It seems client have already closed connection."+e.getMessage());
        }
    }
    ...
    private void onError(Throwable e) {
        Log.i(TAG,"HttpProxyCacheServer error", e);
    }
