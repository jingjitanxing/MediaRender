...
import static com.gxh.video_cache.ProxyCacheUtils.DEFAULT_BUFFER_SIZE;
...
public class HttpUrlSource implements Source {
    ...
    public void close() throws ProxyCacheException {
        if (connection != null) {
            try {
                ...
                Log.i(TAG,"Error closing connection correctly. Should happen only on Android L. " +
    ...
    private void fetchContentInfo() throws ProxyCacheException {
        Log.i(TAG,"Read content info from " + sourceInfo.url);
        ...
        try {
            ...
            Log.i(TAG,"Error fetching info from " + sourceInfo.url, e);
        } finally {
